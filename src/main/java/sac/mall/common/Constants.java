...
public class Constants {
    //public final static String FILE_UPLOAD_DIC = "D:\\soft\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    public final static String FILE_UPLOAD_DIC = "E:\\MyJava\\school-mall\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
